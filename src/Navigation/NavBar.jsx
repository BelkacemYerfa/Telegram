 ...
 return (
  <div className="NavBar" >
    <div className="NavComponentsOptions" >
     <Link to='/' className="ChatOptionSelector group " 
      onClick={HandleStrockeColor}
     >
     ...
     <Link to='/Personal' className="ChatOptionSelector group "
     onClick={HandleStrockeColorFalse} >
     <div className="SelectedType " ></div>
      <div className="chatItem">
        <div className="ChatOptionHolderIcon" >
     ...
     <Link to='/AskAI' className="ChatOptionSelector group" 
     onClick={HandleStrockeColorFalse}>
      <div className="SelectedType " ></div>
      <div className='ChatItem' >
       <div className="ChatOptionHolderIcon" >
        <img src="https://brandlogovector.com/wp-content/uploads/2023/01/ChatGPT-Icon-Logo-PNG.png" 
